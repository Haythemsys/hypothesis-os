...
export const SIDEBAR_EXTRA: NavItem[] = [
  ...
  { href: "/executive-ai",        label: "Executive AI",       icon: "▤" },
  { href: "/board-brief",         label: "Board Brief",        icon: "▤" },
  { href: "/risk-map",            label: "Risk Map",           icon: "⊛" },
  { href: "/intelligence-score",  label: "Intel Score",        icon: "◆" },
  { href: "/copilot",             label: "Copilot",            icon: "✦" },
  { href: "/search",              label: "Search",             icon: "⌕" },
  { href: "/decision-memory",     label: "Decision Memory",    icon: "⟳" },
  { href: "/learning",            label: "Learning Engine",    icon: "⊿" },
  { href: "/knowledge",           label: "Knowledge",          icon: "◆" },
  { href: "/evidence-upload",     label: "Evidence Upload",    icon: "↑" },
  { href: "/evidence-analysis",   label: "Evidence Analysis",  icon: "⊞" },
